...
public class BookConfig {
        ...
        CommandLineRunner commandLineRunner(
                ...
                return args -> {
                        ...
                        /*
                         * Borrow usseifBorrow1 = new Borrow(usseif, allMySons, LocalDate.of(2000,
                         * Month.JANUARY, 5));
                         * Borrow usseifBorrow2 = new Borrow(usseif, hamlet, LocalDate.of(2000,
                         * Month.JANUARY, 5));
                         * Borrow eslamBorrow1 = new Borrow(eslam, allMySons, LocalDate.of(2000,
                         * Month.JANUARY, 5));
                         * Borrow eslamBorrow2 = new Borrow(eslam, hamlet, LocalDate.of(2000,
                         * Month.JANUARY, 5));
                         * 
                         * List<Borrow> usseifBorrows = Arrays.asList(usseifBorrow1, usseifBorrow2);
                         * List<Borrow> eslamBorrows = Arrays.asList(eslamBorrow1, eslamBorrow2);
                         * 
                         * usseif.setBorrow(usseifBorrows);
                         * eslam.setBorrow(eslamBorrows);
                         * 
                         * patronRepository.saveAll(List.of(usseif, eslam));
                         */
